...
| **أحمد حلمي العطار (Ahmed Helmy)** | مهندس الذكاء الاصطناعي و ML | خوارزمية مستعمرات النمل ACO، تحليل تدفق المرور والرؤية الحاسوبية |
...
| **علي يسر (Aly Yoser)** | مهندس الأنظمة المدمجة والهاردوير | تصميم وحدات الـ RSU، برمجة المتحكمات C/C++ وشبكات الـ Mesh |
